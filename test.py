...
while (1):
    ...
    if num == 1:
        ...
        if cap.isOpened():
            ...
            while True:
                ...
                if ret:
                    ...
                    if cv2.waitKey(1) != -1:
                        cv2.imwrite('knowns/{}.jpg'.format(id), frame)
                        break
        ...
        print('Face recognition registered!')
        continue
        ...
        if __name__ == '__main__':
            ...
            # do a bit of cleanup
            cv2.destroyAllWindows()
            print('{} face recognition is complete. Please come in.'.format(name))
            continue
